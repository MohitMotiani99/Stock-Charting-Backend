...
import com.StockCharting.Sector.dto.ErrorMessage;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> sectorAlreadyExistsExceptionHandler(SectorAlreadyExistsException exception, WebRequest request){
        return ResponseEntity.status(HttpStatus.CONFLICT).body(new ErrorMessage(HttpStatus.CONFLICT,exception.getMessage()));
    }
