...
public class StockPriceServiceImpl implements StockPriceService{
    ...
    @Override
    public ChartResponse getStockPricesOvertimeForACompany(String stockExchangeName, String companyCode,String start,String end) {
        ...
        List<StockSeries1> stockSeries1List = getALlStockPriceData()
                .stream()
                .filter(stockPrice -> stockPrice.getStockExchangeName().equals(stockExchangeName) && stockPrice.getCompanyCode().equals(companyCode))
...
//                    System.out.println(b);
        ...
        chartResponse.setStockSeries1List(stockSeries1List.stream()
    ...
    public ChartResponse getStockPricesOvertimeForStockExchange(String stockExchangeName, String start, String end) throws StockExchangeNotFoundException {
        ...
        for(LocalDate ld=startDate;ld.isBefore(endDate);ld=ld.plusDays(1)){
            if(!map.containsKey(ld)){
                ...
                list.add(new StockSeries1(cprice,ld));
                map.put(ld,list);
            }
        }
