...
import com.StockCharting.IPO.dto.ErrorMessage;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> ipoNotFoundExceptionHandler(IpoNotFoundException exception, WebRequest request){
